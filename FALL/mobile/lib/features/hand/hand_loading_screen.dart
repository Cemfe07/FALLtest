...
class _HandLoadingScreenState extends State<HandLoadingScreen> {
  ...
  /// Arka plana alınca bağlantı koptu (499 / ClientException) - retry veya detail ile devam
    ...
    try {
      ...
      for (var i = 1; i <= maxTry; i++) {
        ...
        try {
          ...
          // 2) değilse generate tetikle (arka plana alınca 499/connection abort olabilir)
          try {
          ...
          // ✅ 402: verify gecikmesi -> retry | 409/429/500: geçici -> retry
          // ✅ connection abort (arka plan): retry - sunucu tamamlamış olabilir
